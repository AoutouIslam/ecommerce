...
<div class="flex justify-center m-6">
    <div class="lg:w-4/12 bg-white p-6 rounded-lg">
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password" id="password" placeholder="choisiser votre mot de passe"
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="répétez votre mot de passe"
